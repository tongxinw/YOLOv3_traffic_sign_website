...
<div style="text-align:center;">
  <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/final_model.png" alt="TF model" title="TF model">
  <em>TF model</em>
</div>
<br/>
...
<div style="text-align:center;">
  <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/gif-3.gif" alt="sample detection with YOLOv3 weights" title="sample detection with YOLOv3 weights">
  <br><em>sample detection with YOLOv3 weights</em>
</div>
<br/>
...
<div style="text-align:center;">
  <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/gif-2.gif" alt="sample detection with tiny YOLOv3 weights" title="sample detection with tiny YOLOv3 weights">
  <br><em>sample detection with tiny YOLOv3 weights</em>
</div>
<br/>
...
<div style="text-align:center;">
  <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/gif.gif" alt="sample detection with custom YOLOv3 weights" title="sample detection with custom YOLOv3 weights">
  <br><em>sample detection with custom YOLOv3 weights</em>
</div>
<br/>
...
- Multilingual Traffic Sign Detector: 
  ...
  Many traffic signs are universally used around the world, such as speed limit signs. However, some commonly used traffic signs containing texts make it hard for foreign drivers to read due to language barriers. Using transfer learning, we can train a customized model using traffic signs contains text messages in different languages, such as stop signs in English (STOP) and stop signs in Chinese (停). The new model will be able to detect traffic signs containing texts and be able to assist drivers traveling in foreign countries.
   ...
   <div style="text-align:center;">
    <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/chinese_stop_sign.jpg" width="180" alt="Chinese stop sign" title="Chinese stop sign">
    <br><em>Chinese stop sign</em>
    <br><em>Source: google</em>
  </div>
  <br/>

  <div style="text-align:center;">
    <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/Korean_Stop_Sign.png" width="180" alt="Korean stop sign" title="Korean stop sign">
    <br><em>Korean stop sign</em><br>
    <em>Source: google</em>
  </div>
  <br/>

  <div style="text-align:center;">
    <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/stop_japan.jpg" width="180" alt="Japanses stop sign" title="Japanses stop sign">
    <br><em>Japanses stop sign</em><br>
    <em>Source: google</em>
  </div>
  <br/>
...
- Object Detection API:
  ...
  **Nice application by [ultralytics.com](https://www.ultralytics.com/)**
  <div style="text-align:center;">
    <img src="https://user-images.githubusercontent.com/26833433/61591130-f7beea00-abc2-11e9-9dc0-d6abcf41d713.jpg" width="250" alt="API example" title="API example">
    <br><em>API example</em><br>
    <em>source: ultralytics.com</em>
  </div>
  <br/>
...
[Chinese stop sign](https://www.google.com/search?q=chinese+stop+sign&tbm=isch&hl=en&chips=q:chinese+stop+sign,g_1:hexagon&hl=en&ved=2ahUKEwi-7fmJha3pAhUXjp4KHe5tBWUQ4lYoAHoECAEQFQ&biw=1440&bih=740#imgrc=zhgIjM17-gzw4M&imgdii=J_GtlQbB3oVTIM)

   Example of stop sign in Chinese.

[Japanese stop sign](https://www.google.com/search?q=chinese+stop+sign&tbm=isch&ved=2ahUKEwjOnZaNhK3pAhWTnZ4KHU4hAkgQ2-cCegQIABAA&oq=chinese+stop+sign&gs_lcp=CgNpbWcQAzICCAAyBggAEAgQHjIECAAQGDoFCAAQgwE6BAgAEENQ8s8PWL_wD2C48g9oAnAAeACAAWyIAYMMkgEEMjAuMZgBAKABAaoBC2d3cy13aXotaW1nsAEA&sclient=img&ei=4Oi5Xs6tBpO7-gTOwojABA&bih=789&biw=1440&hl=en#imgrc=Zszq7BXzBJScRM)

   Example of stop sign in Japanese. 

[Korean stop sign](https://www.google.com/search?q=korean+stop+sign&tbm=isch&hl=en&hl=en&ved=2ahUKEwi-7fmJha3pAhUXjp4KHe5tBWUQrNwCKAB6BAgBEGw&biw=1440&bih=740#imgrc=_aSH_2n9_evvTM)

   Example of stop sign in Korean.

[ultralytics.com](https://www.ultralytics.com/)
