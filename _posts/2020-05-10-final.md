...
To test our custom detector, we used the [video](https://m.youtube.com/watch?v=7HaJArMDKgI)[^1] from the dash cam recorder of a car. We limited the video within 20 seconds, generating the results in a timely manner. The following video is an example of our testing: 
...
- Multilingual Traffic Sign Detector: 
  ...
  Many traffic signs are universally used around the world, such as speed limit signs. However, some commonly used traffic signs containing texts make it hard for foreign drivers to read due to language barriers. Using transfer learning, we can train a customized model using traffic signs contains text messages in different languages, such as stop signs in English (STOP) and stop signs in Chinese (停). The new model will be able to detect traffic signs containing texts and be able to assist drivers traveling in foreign countries. 
   ...
   <div style="text-align:center;">
    <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/chinese_stop_sign.jpg" width="180" alt="Chinese stop sign">
    <em>Source: google</em>
  </div>
  <br/>

  <div style="text-align:center;">
    <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/Korean_Stop_Sign.png" width="180" alt="Korean stop sign">
    <em>Source: google</em>
  </div>
  <br/>

  <div style="text-align:center;">
    <img src="https://github.com/tongxinw/YOLOv3_traffic_sign_website/raw/gh-pages/img/stop_japan.jpg" width="180" alt="Japanses stop sign">
    <em>Source: google</em>
  </div>
  <br/>
...
- Object Detection API:
  ...
  **Nice application by [ultralytics.com](https://www.ultralytics.com/)**
  <div style="text-align:center;">
    <img src="https://user-images.githubusercontent.com/26833433/61591130-f7beea00-abc2-11e9-9dc0-d6abcf41d713.jpg" width="250" alt="sample detection with custom YOLOv3 weights">
  </div>
  <br/>
...
[^1] [Video from a Dash Cam Recorder in New York](https://www.youtube.com/watch?v=7HaJArMDKgI&app=desktop)
